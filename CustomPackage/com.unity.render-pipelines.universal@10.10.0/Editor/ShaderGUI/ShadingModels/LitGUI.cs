...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    [MovedFrom("UnityEditor.Rendering.LWRP.ShaderGUI")] public static class LitGUI
    {
        ...
        {
            public static GUIContent DissolveClip = new GUIContent("DissoveClipValue", "FuckWorld");
        ...
        {
            public MaterialProperty dissolveClipValue;
            ...
            {
                dissolveClipValue = BaseShaderGUI.FindProperty("_Clip", properties, false);
                // Surface Option Props

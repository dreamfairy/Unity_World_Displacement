Shader "Universal Render Pipeline/KaguraLit"
{
    Properties
    {
        [Header(Dissolve)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Custom
            #pragma multi_compile GLOBAL_DISSOLVE
            ...
            #pragma vertex LitPassVertexDissolve
            ...
            Varyings LitPassVertexDissolve(Attributes input)
            {
            ...
            half4 LitPassFragmentDissolve(Varyings input) : SV_Target
            {
                UNITY_SETUP_INSTANCE_ID(input);
